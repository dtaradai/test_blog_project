  <section class="top">
    <div class="container">
      <div class="top__inner">
        ...
        <button class="top__btn signUp">Get started</button>
      ...
      <div class="container">
        <div class="tools__items">
          ...
          <div class="tools__item">
            <img class="tools__item-img" src="<?php echo DIR_IMAGES ?>tools-1.svg" alt="tools img">
            <h5 class="tools__item-title title">
              First click tests
            </h5>
          ...
          <div class="tools__item">
            <img class="tools__item-img" src="<?php echo DIR_IMAGES ?>tools-2.svg" alt="tools img">
            <h5 class="tools__item-title title">
              Design surveys
            </h5>
            <p class="tools__item-text">
          ...
          <div class="tools__item">
            <img class="tools__item-img" src="<?php echo DIR_IMAGES ?>tools-3.svg" alt="tools img">
            <h5 class="tools__item-title title">
              Preference tests
            </h5>
            <p class="tools__item-text">
          ...
          <div class="tools__item">
            <img class="tools__item-img" src="<?php echo DIR_IMAGES ?>tools-4.svg" alt="tools img">
            <h5 class="tools__item-title title">
              Five second tests
            </h5>
            <p class="tools__item-text">
    ...
    <div class="container">
      ...
      <div class="direction__item">
        <div class="direction__item-content">
          ...
          <h3 class="direction__item-title title">
        ...
        <img class="direction__item-img" src="<?php echo DIR_IMAGES ?>direction-1.svg" alt="Design Professionals images">
      </div>

      <div class="direction__item">
        <img class="direction__item-img" src="<?php echo DIR_IMAGES ?>direction-2.svg" alt="Design Professionals images">
        <div class="direction__item-content">
          <p class="direction__item-pretitle">
      ...
      <div class="direction__item">
        ...
        <img class="direction__item-img" src="<?php echo DIR_IMAGES ?>direction-3.svg" alt="Design Professionals images">
      </div>
    ...
    <div class="container">
      <div class="team__inner">
        ...
        <div class="team__item team__item--1">
          <img class="team__item-img" src="<?php echo DIR_IMAGES ?>team-1.jpg" alt="photo">
          <p class="team__item-text team__item-text--right">
            I can help marketing strategy
          </p>
        </div>
        <div class="team__item team__item--2">
          <img class="team__item-img" src="<?php echo DIR_IMAGES ?>team-2.jpg" alt="photo">
          <p class="team__item-text team__item-text--left">
            I can help marketing strategy
          </p>
        </div>
        <div class="team__item team__item--3">
          <img class="team__item-img" src="<?php echo DIR_IMAGES ?>team-3.jpg" alt="photo">
          <p class="team__item-text team__item-text--right">
            I can help marketing strategy
          </p>
        </div>
        <div class="team__item team__item--4">
          <img class="team__item-img" src="<?php echo DIR_IMAGES ?>team-4.jpg" alt="photo">
          <p class="team__item-text team__item-text--right">
            I can help marketing strategy
          </p>
        </div>
        <div class="team__item team__item--5">
          <img class="team__item-img" src="<?php echo DIR_IMAGES ?>team-5.jpg" alt="photo">
          <p class="team__item-text team__item-text--right">
            I can help marketing strategy
          </p>
        </div>
        ...
        <div class="team__box">
          ...
          <button class="team__btn signUp">Contact our expert</button>
        </div>
    ...
    <div class="container">
      ...
      <div class="slider">
        ...
        <div class="slider__item">
          <img class="slider__item-img" src="<?php echo DIR_IMAGES ?>blog1.jpg" alt="blog images">
        ...
        <div class="slider__item">
          <img class="slider__item-img" src="<?php echo DIR_IMAGES ?>blog2.jpg" alt="blog images">
          <div class="slider__item-info">
            By <a class="slider__item-author" href="#">Abdullah</a> | 03 March 2019
          </div>
          <a class="slider__item-title title" href="#">
        ...
        <div class="slider__item">
          <img class="slider__item-img" src="<?php echo DIR_IMAGES ?>blog3.jpg" alt="blog images">
          <div class="slider__item-info">
            By <a class="slider__item-author" href="#">Abdullah</a> | 03 March 2019
          </div>
          <a class="slider__item-title title" href="#">
    ...
    <div class="container">
      ...
      <div class="footer__inner">
        ...
        <form action="#" class="footer__form">
          ...
          <button class="footer__form-btn signUp" type="submit">Sign up Now</button>
        </form>
